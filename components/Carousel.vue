<template>
    <section class="carousel-container">
        <div class="buttons-container" v-if="amount > 3">
            <div class="left arrow" :class="{ 'disabled' : current <= 1 }" @click="previous()">
                <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            >
                ...
                >
                    <path
                        d="M3.99984 12.9999L3.99984 10.9999L15.9998 10.9999L10.4998 5.49992L11.9198 4.07992L19.8398 11.9999L11.9198 19.9199L10.4998 18.4999L15.9998 12.9999L3.99984 12.9999Z"
                        fill="#F4F4F4"
                    />
                </svg>
            </div>
    ...
    .scroll-wrapper {
        ...
        .carousel {
            ...
            > * {
                ...
                width: calc(
                    ((100vw - var(--outer) - var(--outer)) / 3) - #{vw(28px)}
                );
                opacity: 0;
